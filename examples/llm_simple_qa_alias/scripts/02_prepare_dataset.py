...
def main():
    parser = argparse.ArgumentParser(
        description="Prepare the llm_simple_qa_alias dataset in Ianvs example layout."
    )
    parser.add_argument(
        "--dataset-root",
        "--output-dir",
        dest="dataset_root",
        type=Path,
        default=Path("./dataset/llm_simple_qa_alias"),
        help="Destination dataset root. Defaults to ./dataset/llm_simple_qa_alias.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
